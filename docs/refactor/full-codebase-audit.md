...
| Coding execution | `src/main/codex/*`, `runtime-adapter.ts`, `coding-task.ts`, `coding-agent.ts` | coding task contract, worker bootstrap protocol and bounded file/search/patch/image/process execution |
